...
def test(direction=direction, model_dir=model_dir, test_dir=test_dir, sr=sr, n_features=n_features,
         frame_period=frame_period):
    param_dir = DATASET_PATH
    ...
    for file in file_list:
        ...
        wav_transformed = world_speech_synthesis(f0=f0_converted, decoded_sp=decoded_sp_converted, ap=ap, fs=sr,
                                                 frame_period=frame_period)
