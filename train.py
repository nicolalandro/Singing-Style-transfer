...
def train(input_A, input_B, g_type=g_type, n_epochs=n_epochs, n_features=n_features, n_frames=n_frames, log_dir=log_dir,
          model_dir=model_dir):
    generator_lr = 0.0002
    ...
    for epoch in range(n_epochs):
        ...
        print("Generator Loss : %f, Discriminator Loss : %f, Time : %02d:%02d" % (
        generator_loss, discriminator_loss, (epoch_time % 3600 // 60), (epoch_time % 60 // 1)))
